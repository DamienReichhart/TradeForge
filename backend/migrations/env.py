...
from app.models.bot import Bot, BotIndicator
from app.models.backtest import Backtest
from app.models.performance import Trade
from app.models.marketing import Tutorial, Opinion
from app.models.subscription import Subscription
target_metadata = Base.metadata

# Populate alembic configuration with values from environment
...
config.set_section_option(section, "POSTGRES_SERVER", os.environ.get("POSTGRES_SERVER", "localhost"))
